...
export class CodeBeamerCardIntegration extends LucidCardIntegration {
	...
	getDefaultConfig = (
		...
		return Promise.resolve({
			cardConfig: {
				fieldNames: [DefaultFieldNames.Subject],
				fieldDisplaySettings: new Map([
					...
					[
						DefaultFieldNames.Owner,
						{
							stencilConfig: {
								displayType: FieldDisplayType.BasicTextBadge,
								tooltipFormula: 'Owner',
								backgroundColor: '=darken("ff00ff", 0.5)',
							},
						},
					],
				]),
